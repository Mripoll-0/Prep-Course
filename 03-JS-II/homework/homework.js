...
function mayoriaDeEdad(edad) {
  ...
  if (edad<18) return "Not allowed"; else return "Allowed"
}
...
function fizzBuzz(numero) {
  ...
  var num=numero;
  if (numero%3==0) num="fizz";
  if (numero%5==0) if (num=="fizz") num=num+"buzz"; else num="buzz";
  return num;
}
